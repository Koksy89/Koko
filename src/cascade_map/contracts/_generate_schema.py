...
ARTIFACTS: dict[str, tuple[str, str]] = {
    ...
    "ledger/versions.jsonl": ("VersionRecord", "id"),
    "ledger/fingerprints.jsonl": ("ElementFingerprint", "id"),
    "ledger/comparisons.jsonl": ("VersionComparison", "id"),
    "requirements.jsonl": ("PackageRequirement", "id"),
    "installed.jsonl": ("InstalledPackage", "id"),
    "package_usage.jsonl": ("PackageUsage", "id"),
    "interpreter.jsonl": ("InterpreterRequirement", "id"),
    "runtime/events.jsonl": ("TraceEvent", "event_id"),
    "runtime/contradictions.jsonl": ("Contradiction", "id"),
    "runtime/nondeterminism.jsonl": ("NondeterminismObservation", "id"),
    "runtime/mapping.json": ("MappingReport", "run_id"),
