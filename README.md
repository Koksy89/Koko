...
**Both modes are complete and gated.** 1235 tests, 0 failing.
...
One file, no package, no dependencies beyond the standard library; Python 3.11 or newer.
    ...
    python3 cascade_map.py analyze /path/to/your_engine --out out/first
    python3 cascade_map.py blueprint out/first      # interactive node canvas
    python3 cascade_map.py view out/first           # the tabular report
